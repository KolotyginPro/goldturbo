        ...
        <div className="grid gap-12 lg:grid-cols-[1fr,1.2fr] items-center">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {[
              ...
              { i: Layers, t: "Без выделенного сервера", d: "Не требуется покупка отдельного сервера и настройка под торговлю" },
        ...
        <div className="mt-14 grid gap-6 md:grid-cols-2">
          {[
            ...
            },
            {
              ...
              d: <>
                После пополнения счёта отправьте в <a href={SUPPORT_URL} target="_blank" rel="noreferrer" className="text-primary underline hover:text-gold-gradient">службу поддержки</a> информацию с указанием номера счёта и просьбой выдачи ссылки на копитрейдинг.
              </>,
            },
            {
              n: "04",
              t: "Настройка копирования",
              d: "После получения ссылки от тех поддержки, переходите по ней и нажимаете кнопку, менять параметры не нужно",
            },
            {
              n: "05",
              t: "Запуск копирования",
              d: "Запуск копирования происходит автоматически, торговля осуществляется с 08:00 - 22:00 по мск, будние дни.",
            },
            {
              n: "06",
              t: "Мониторинг и управление",
              d: "Следите за статистикой в личном кабинете RoboForex или через мобильное приложение. Вы можете остановить копирование в любой момент. ",
            },
          ].map((s) => (
            <div key={s.t} className="relative rounded-2xl border border-border/50 bg-card-gradient p-6 transition-smooth hover:border-gold">
